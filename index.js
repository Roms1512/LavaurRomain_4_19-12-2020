...
// on créer un fonction, ici 'showAllCamera'
    ...
    const createCamera = (camera) => {
        ...
        let secondDiv = document.createElement('div');  secondDiv.classList.add('image');
        let secondP = document.createElement('p');      secondP.classList.add('prix-produit');
        let thirdDiv = document.createElement('div');  thirdDiv.classList.add('info-produit');
        let thirdP = document.createElement('p');     thirdP.classList.add('taille-produit');
        let fourDiv = document.createElement('div');    fourDiv.classList.add('button');
...
const log = document.getElementById('produits');
